  ...
  return (
    <div className="min-h-screen bg-zinc-900">
      ...
      <main className="flex items-center justify-center pt-20 pb-16 px-4 md:px-6">
        ...
        <h1 className="text-3xl md:text-4xl font-extrabold mb-4 text-white">Terms of Service</h1>
        ...
        <section className="mb-6">
          <h2 className="text-xl font-bold mb-2 text-white">What You're Agreeing To (TL;DR)</h2>
        ...
        <section className="mb-6">
          <h2 className="text-xl font-bold mb-2 text-white">Who Can Use This</h2>
          <p className="text-zinc-300">You must be at least 18 years old and legally capable of signing contracts (real estate agents, we're looking at you). You also agree that all the info you give us is real — no fake names, burner emails, or shady shenanigans.</p>
        </section>
        <section className="mb-6">
          <h2 className="text-xl font-bold mb-2 text-white">Your Account, Your Responsibility</h2>
          <ul className="list-disc pl-6 space-y-1 text-zinc-300">
        ...
        <section className="mb-6">
          <h2 className="text-xl font-bold mb-2 text-white">What You Can't Do</h2>
          <ul className="list-disc pl-6 space-y-1 text-zinc-300">
        ...
        <section className="mb-6">
          <h2 className="text-xl font-bold mb-2 text-white">Email Responsibility (aka, Don't Blame Us)</h2>
          <p className="text-zinc-300">BossyEmail helps you write great emails, but what you do with them is on you. We're not responsible for deals gone bad, leads that ghost you, or typos that make it past your coffee-deprived eyes.</p>
        </section>
        <section className="mb-6">
          <h2 className="text-xl font-bold mb-2 text-white">Payments and Subscriptions</h2>
          <ul className="list-disc pl-6 space-y-1 text-zinc-300">
        ...
        <section className="mb-6">
          <h2 className="text-xl font-bold mb-2 text-white">We Can Make Changes (And We Probably Will)</h2>
          <p className="text-zinc-300">We might update or improve BossyEmail, fix bugs, change features, or adjust pricing. We also reserve the right to suspend or terminate access to anyone who's abusing the platform, breaking the law, or just being a pain.</p>
        </section>
        <section className="mb-6">
          ...
          <p className="mt-2 text-zinc-300">Use at your own risk. We're not liable for lost time, lost money, or lost sanity.</p>
        </section>
        <section className="mb-6">
          <h2 className="text-xl font-bold mb-2 text-white">Legal Stuff</h2>
          <ul className="list-disc pl-6 space-y-1 text-zinc-300">
        ...
        <section className="mb-6">
          ...
          <p className="text-zinc-300">Reach out. We don't bite.<br />📩 <a href="mailto:aylen@bossyemail.com" className="underline text-[#D1B4C6] hover:text-[#C4A7B9]">aylen@bossyemail.com</a></p>
        </section>
        <div className="mt-8 text-base font-semibold text-zinc-300">Because real estate doesn't need more chaos — just better emails.</div>
        </div>
      </main>
    </div>
  );
