        ...
        <div className="w-full bg-white border border-[#E3E3E3] rounded-none p-6 md:p-8 flex flex-col items-center">
          ...
          <div className="text-center mt-4">
            <p className="text-sm text-[#505050]" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>
              Already have an account? <a href="/sign-in" className="text-[#161616] hover:text-[#505050] font-medium">Sign in</a>
            </p>
            <p className="text-xs text-[#ABABAB] mt-3" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>
