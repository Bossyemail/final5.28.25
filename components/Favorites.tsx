    ...
    return (
      <div className="w-full pl-8 pr-8 sm:pl-4 sm:pr-4" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>
        <div className="max-w-4xl mx-auto py-8">
          <h2 className="text-2xl font-normal mb-6 text-[#161616] dark:text-white" style={{ fontFamily: 'var(--font-inter-tight), sans-serif', fontWeight: 400 }}>Favorites</h2>
          ...
          <p className="text-sm text-[#505050] dark:text-[#ABABAB]" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>Please upgrade your plan to access favorites.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="w-full pl-8 pr-8 sm:pl-4 sm:pr-4" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>
      <div className="max-w-4xl mx-auto py-8">
        <div className="flex items-center mb-8 gap-3">
          <h2 className="text-2xl font-normal text-[#161616] dark:text-white" style={{ fontFamily: 'var(--font-inter-tight), sans-serif', fontWeight: 400 }}>Favorites</h2>
          <button
      ...
      <div className="mb-6 w-full">
        <div className="relative flex items-center w-full bg-white dark:bg-[#1a1a1a] border border-[#E3E3E3] dark:border-[#292929] rounded-2xl shadow-sm hover:shadow-md transition-shadow focus-within:border-[#161616] dark:focus-within:border-white focus-within:shadow-md h-12">
          <input
            type="text"
            placeholder="Search favorites..."
            value={searchInput}
            onChange={e => setSearchInput(e.target.value)}
            className="flex-1 px-5 h-full text-base text-[#161616] dark:text-white placeholder-[#ABABAB] bg-transparent border-none rounded-2xl focus:outline-none"
            style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}
          />
          {searchInput && (
            <button
        ...
        {Object.keys(groupedFavorites).length === 0 ? (
          ...
          <p className="text-base font-medium mb-2 text-[#161616] dark:text-white" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>No favorites yet</p>
          ...
          {Object.entries(groupedFavorites).map(([category, favs]) => (
            ...
            >
              <div className="flex-1 min-w-0">
                      <div className="text-base font-medium text-[#161616] dark:text-white truncate" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>{fav.subject}</div>
      ...
      {showModal && selectedFavorite && (
        ...
        >
          <div
              className="bg-white dark:bg-[#1a1a1a] rounded-lg shadow-xl w-full max-w-3xl sm:max-w-lg p-6 relative"
          ...
          >
            ...
            <div className="mb-6">
                ...
                <div className="mb-4 text-base text-[#161616] dark:text-white whitespace-pre-line" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>
                {selectedFavorite.subject}
              </div>
                <div className="font-medium text-[#161616] dark:text-white mb-2" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>Body:</div>
                <div className="text-base text-[#161616] dark:text-white whitespace-pre-line" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>
        ...
        {showAddModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" onClick={() => setShowAddModal(false)}>
            <div
              className="bg-white dark:bg-[#1a1a1a] rounded-lg shadow-xl w-full max-w-xl p-8 relative flex flex-col max-h-[90vh] overflow-y-auto"
            ...
            >
              ...
              <h3 className="text-base font-medium mb-4 text-[#161616] dark:text-white" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>Add New Template</h3>
              <form
                onSubmit={e => {
                  e.preventDefault();
              ...
              >
                <div>
                  <label className="block text-sm font-medium mb-1 text-[#505050] dark:text-[#ABABAB]" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>Title<span className="text-red-500">*</span></label>
                  <input
                    type="text"
                    value={newTemplate.subject}
                    onChange={e => setNewTemplate(t => ({ ...t, subject: e.target.value }))}
                    className="w-full px-3 py-2 rounded-none border border-[#E3E3E3] dark:border-[#292929] bg-white dark:bg-[#1a1a1a] text-[#161616] dark:text-white placeholder-[#ABABAB] focus:outline-none focus:ring-2 focus:ring-[#161616] dark:focus:ring-white focus:border-[#161616] dark:focus:border-white"
                    style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}
                ...
                <div>
                  <label className="block text-sm font-medium mb-1 text-[#505050] dark:text-[#ABABAB]" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>Body<span className="text-red-500">*</span></label>
                  <textarea
                    value={newTemplate.body}
                    onChange={e => setNewTemplate(t => ({ ...t, body: e.target.value }))}
                    className="w-full px-3 py-2 rounded-none border border-[#E3E3E3] dark:border-[#292929] bg-white dark:bg-[#1a1a1a] text-[#161616] dark:text-white placeholder-[#ABABAB] focus:outline-none focus:ring-2 focus:ring-[#161616] dark:focus:ring-white focus:border-[#161616] dark:focus:border-white resize-y min-h-[120px] max-h-[400px]"
                    style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}
                ...
                <div>
                  <label className="block text-sm font-medium mb-1 text-[#505050] dark:text-[#ABABAB]" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>Category</label>
                  <select
                    value={newTemplate.category}
                    onChange={e => setNewTemplate(t => ({ ...t, category: e.target.value }))}
                    className="w-full px-3 py-2 rounded-none border border-[#E3E3E3] dark:border-[#292929] bg-white dark:bg-[#1a1a1a] text-[#161616] dark:text-white focus:outline-none focus:ring-2 focus:ring-[#161616] dark:focus:ring-white focus:border-[#161616] dark:focus:border-white"
                    style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}
                  >
                ...
                <button
                  type="submit"
                  className="mt-2 px-4 py-2 rounded-none border border-[#161616] dark:border-white bg-[#161616] dark:bg-white text-white dark:text-[#161616] font-medium hover:bg-[#292929] dark:hover:bg-[#FBFBFB] transition-colors"
                  style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}
                >
                  Save
                </button>
              ...
              {(newTemplate.subject || newTemplate.body) && (
                <div className="mt-6 p-4 rounded-lg bg-[#FBFBFB] dark:bg-[#292929] border border-[#E3E3E3] dark:border-[#292929] max-h-[200px] overflow-y-auto">
                  <div className="text-xs font-medium text-[#505050] dark:text-[#ABABAB] mb-1" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>Preview</div>
                  <div className="text-base font-medium text-[#161616] dark:text-white mb-1" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>{newTemplate.subject || <span className="italic text-[#ABABAB] dark:text-[#ABABAB]">(No title)</span>}</div>
                  <div className="text-sm text-[#505050] dark:text-[#ABABAB] whitespace-pre-line" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>{newTemplate.body || <span className="italic text-[#ABABAB] dark:text-[#ABABAB]">(No body)</span>}</div>
                </div>
              )}
            </div>
          </div>
