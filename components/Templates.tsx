...
import { Mail, Clipboard, Pencil, Trash2, Filter, Star, Clock } from "lucide-react";
...
const MOCK_TEMPLATES = [
  ...
  },
  {
    ...
    category: CONTRACT_STAGES.POST_CLOSING_COMPLETION,
  },
  {
    id: "t4",
  ...
  // Title, Association & Closing Coordination Templates
  {
    id: "tac_association_documents_request",
    title: "Request for Association Documents (Condo/HOA Rider Compliance)",
    body: `Subject: Request for association documents – [Property Address]\n\nHi [Association Manager Name],\n\nGood morning — I'm the transaction coordinator for the sale of [Property Address], and I'm reaching out to request the documents required under the Florida Condominium/HOA Rider.\n\nPlease provide the following as soon as possible:\nMost recent budget and year-end financials\nRules and Regulations\nFrequently Asked Questions (FAQ) sheet\nMaster Insurance Certificate\nEstoppel Letter or Lender's Questionnaire (as applicable)\nAny available Milestone Inspection or SIRS Report, if completed\n\nThese items are required for contract compliance and to ensure the buyer's lender and title company have accurate, current information.\n\nPlease send to:\n📩 [Your Email Address]\n📎 [Title Company Email, if needed]\n\nThank you in advance for your assistance — your help in expediting this is greatly appreciated.\n\nWarm regards,`,
    category: CONTRACT_STAGES.TITLE_ASSOCIATION,
  },
  {
    id: "tac_estoppel_letter_request",
    title: "Estoppel Letter / Lender's Questionnaire Request",
    body: `Subject: Request for estoppel letter or lender's questionnaire – [Property Address]\n\nHi [Association Manager Name],\n\nI'm the transaction coordinator for the upcoming closing of [Property Address].\n\nPlease advise on the process and fee required to order the Estoppel Letter and/or Lender's Questionnaire for this unit.\n\nIf possible, please include:\nPayment instructions\nTurnaround time\nContact for delivery of the completed estoppel/questionnaire\n\nPlease send the completed document(s) to:\n📩 [Title Company Email]\nCC: [Your Email]\n\nThank you in advance for your time and assistance — we appreciate your help keeping this transaction on schedule.\n\nBest regards,`,
    category: CONTRACT_STAGES.TITLE_ASSOCIATION,
  },
  {
    id: "tac_wire_fraud_advisory",
    title: "Wire Fraud Advisory",
    body: `Subject: Important: Wire fraud prevention reminder – [Property Address]\n\nHi [Client First Name],\n\nAs we move closer to closing, please take a moment to review this important wire fraud advisory.\n\nWire fraud is a growing threat in real estate transactions. Scammers can intercept or alter legitimate emails and provide fraudulent wire instructions.\n\nTo protect your funds:\n1. Never wire funds without first calling the title company directly using a verified phone number from your contract or title commitment.\n2. Do not rely on emailed or texted wire instructions — verify verbally every time.\n3. Never respond to any last-minute changes in wiring details.\n\nIf you receive any suspicious message or revised instructions, call your agent or me immediately.\n\nYour security is our top priority. Please keep this message for reference when wiring your closing funds.\n\nWarm regards,`,
    category: CONTRACT_STAGES.TITLE_ASSOCIATION,
  },
  {
    id: "tac_searches_clear",
    title: "Confirmation – All Searches Received & Clear",
    body: `Subject: Title and lien searches clear – [Property Address]\n\nHi [First Name],\n\nThe title company has confirmed that all property searches — title, lien, tax, and association — have been completed and are clear of any issues.\n\nThis means there are no outstanding liens, open permits, or title defects affecting the property.\n\nWe're officially on track for closing as scheduled on [Date].\n\nI'll continue monitoring for final loan package and estoppel confirmations, but for now, we're in excellent shape.\n\nBest regards,`,
    category: CONTRACT_STAGES.TITLE_ASSOCIATION,
  },
  {
    id: "tac_searches_pending",
    title: "Confirmation – Searches Received, Pending Clearance",
    body: `Subject: Title and lien searches received – pending clearance\n\nHi [First Name],\n\nThe title company has received the property's lien and title searches for [Property Address].\n\nThey're currently reviewing to confirm all items are clear before finalizing title.\n\nIf any issues arise (such as open permits or unpaid balances), I'll notify you right away and coordinate with the appropriate parties to resolve them prior to closing.\n\nWe're in the home stretch — just awaiting final clearance.`,
    category: CONTRACT_STAGES.TITLE_ASSOCIATION,
  },
  {
    id: "tac_mobile_notary_request",
    title: "Mobile Notary Request",
    body: `Subject: Request for mobile notary appointment – [Client Name], [Property Address]\n\nHi [Title Rep Name],\n\nPlease arrange a mobile notary for our client [Client Full Name] to complete their signing for [Property Address].\n\nPreferred details:\nDate: [Requested Date]\nTime: [Preferred Time]\nLocation: [Client's Address or Business Location]\nContact: [Client Phone Number]\nDocuments: Closing package for [Buyer/Seller]\nSpecial Notes: [e.g., requires Spanish-speaking notary / after-hours appointment]\n\nPlease confirm once the notary has been scheduled and provide tracking for the executed documents once returned.\n\nThank you so much for coordinating — this client will truly appreciate the flexibility.\n\nBest,`,
    category: CONTRACT_STAGES.TITLE_ASSOCIATION,
  },
  {
    id: "tac_mobile_notary_confirmation",
    title: "Mobile Notary Confirmation to Client",
    body: `Subject: Mobile notary confirmed for your signing – [Property Address]\n\nHi [Client First Name],\n\nYour mobile notary appointment has been confirmed for:\n📅 Date: [Date]\n⏰ Time: [Time]\n📍 Location: [Address]\n\nThe notary will bring your final closing documents and walk you through the signing process. Please have your photo ID ready.\n\nOnce your documents are signed, the notary will return them directly to title for final review and recording.\n\nWe'll confirm once everything has been received and funding is complete.\n\nYou're almost there — congratulations in advance!`,
    category: CONTRACT_STAGES.TITLE_ASSOCIATION,
  },
  {
    id: "tac_final_coordination",
    title: "Final Coordination – Title, Association, and Lender",
    body: `Subject: Final coordination before closing – [Property Address]\n\nHi Everyone,\n\nWe're approaching the finish line for [Property Address], and I want to ensure all closing items are aligned:\n✅ Title: Confirmed clear and ready to fund\n✅ Lender: Final CD issued and closing package en route\n✅ Association: Estoppel/approval received\n✅ Buyer/Seller: Wire verification completed\n\nPlease confirm if any outstanding items remain on your end. My goal is to make sure we walk into closing fully prepared with no last-minute surprises.\n\nAppreciate the teamwork!`,
    category: CONTRACT_STAGES.TITLE_ASSOCIATION,
  },
  // Post-Closing & File Completion Templates
  {
    id: "pcf_funding_confirmation",
    title: "Funding Confirmation",
    body: `Subject: Funding confirmed – [Property Address]\n\nHi [Client First Name],\n\nI'm happy to confirm that [Property Address] has officially funded and recorded! 🎉\n\nThe title company has confirmed all funds have been disbursed, and the transaction is fully complete.\n\nAttached for your records:\nFinal Closing Disclosure / Settlement Statement\nRecorded Deed (if available at this time)\n\nThank you again for allowing us to be part of your journey — it truly takes a team to reach the finish line, and we're grateful to have supported you through it.\n\nWarm regards,`,
    category: CONTRACT_STAGES.POST_CLOSING_COMPLETION,
  },
  {
    id: "pcf_closing_package_delivered",
    title: "Closing Package Delivered",
    body: `Subject: Closing package – [Property Address]\n\nHi [Client First Name],\n\nAttached you'll find your complete closing package for [Property Address], including:\nFinal Settlement Statement\nRecorded Deed\nLoan and Title Documents\nAssociation Estoppel (if applicable)\n\nPlease download and save these files for your records — they'll be important for future tax filings and insurance updates.\n\nIf you have any questions or need a copy resent later, don't hesitate to reach out.\n\nThank you again for allowing us to be part of your closing!`,
    category: CONTRACT_STAGES.POST_CLOSING_COMPLETION,
  },
  {
    id: "pcf_disbursement_confirmation",
    title: "Disbursement Confirmation (Internal to Brokerage or Team)",
    body: `Subject: Commission disbursed – [Property Address]\n\nHi [Agent Name] / [Accounting Contact],\n\nThe title company has confirmed commission disbursement for [Property Address] as of [Date].\n\nAttached:\nFinal CD / Settlement Statement\nWire Confirmation (if applicable)\n\nPlease review and confirm receipt. If any discrepancies arise, let me know so I can follow up with title immediately.\n\nFile is officially complete on our end.`,
    category: CONTRACT_STAGES.POST_CLOSING_COMPLETION,
  },
  {
    id: "pcf_file_completion_confirmation",
    title: "File Completion Confirmation (To Agent or Team Lead)",
    body: `Subject: File complete – [Property Address]\n\nHi [Agent Name],\n\nThe transaction file for [Property Address] is fully closed and documented.\n\nWhat's included in the final file:\n✅ Executed Contract & Addenda\n✅ Title Docs / Closing Package\n✅ Disclosures, Estoppels, and Approvals\n✅ Commission Confirmation\n✅ Final CD and Deed\n\nAll documents have been saved to the shared drive under [Folder Name or Platform] for compliance and recordkeeping.\n\nWe are clear and closed on this one — great teamwork!`,
    category: CONTRACT_STAGES.POST_CLOSING_COMPLETION,
  },
  {
    id: "pcf_post_closing_checkin",
    title: "Post-Closing Client Check-In",
    body: `Subject: Checking in after your closing – [Property Address]\n\nHi [Client First Name],\n\nJust wanted to check in and make sure everything went smoothly after closing.\n\nHow are things settling in? Any questions or loose ends I can help tie up?\n\nIf you'd like, I can also send a quick list of trusted local vendors — cleaners, movers, handymen, locksmiths — who've worked with our clients before.\n\nIt was a pleasure working with you, and I hope you're enjoying the start of this new chapter. Remember, we're always here if you need us.\n\nWarmly,`,
    category: CONTRACT_STAGES.POST_CLOSING_COMPLETION,
  },
  {
    id: "pcf_testimonial_request",
    title: "Testimonial Request",
    body: `Subject: A quick favor — would you share your experience?\n\nHi [Client First Name],\n\nIt was such a pleasure working with you on your recent [purchase/sale] of [Property Address].\n\nIf you had a great experience, would you mind sharing a short testimonial or Google review? It really helps future clients find us and know they're in good hands.\n\nYou can leave your feedback here:\n⭐ [Insert Google / Zillow / Website Review Link]\n\nThank you again for your trust — it truly means the world to our team.\n\nWarm regards,`,
    category: CONTRACT_STAGES.POST_CLOSING_COMPLETION,
  },
  {
    id: "pcf_still_here_followup",
    title: "We're Still Here for You Follow-Up (30 Days After Closing)",
    body: `Subject: 30 days since closing — we're still here if you need us\n\nHi [Client First Name],\n\nCan you believe it's already been a month since you closed on [Property Address]?\n\nI just wanted to reach out and let you know we're still here for you — whether you need help with documents, vendor referrals, or have questions about property tax filings or homestead exemption.\n\nWe loved being part of your transaction and hope you'll think of us for any future real estate needs — or refer us to someone who could use a team like ours.\n\nWishing you continued success and happiness,`,
    category: CONTRACT_STAGES.POST_CLOSING_COMPLETION,
  },
  {
    id: "pcf_annual_anniversary",
    title: "Annual Anniversary Follow-Up",
    body: `Subject: Happy closing anniversary! 🎉\n\nHi [Client First Name],\n\nOne year ago today, you closed on [Property Address]!\n\nI hope it's been a great year in your home. If you're curious about current market value, rental potential, or just want a quick equity check, I can have that ready for you in minutes — no pressure, just information.\n\nWishing you continued success and many happy returns on your investment!\n\nCheers,`,
    category: CONTRACT_STAGES.POST_CLOSING_COMPLETION,
  },
  {
    id: "pcf_file_archived",
    title: "File Archived (Internal)",
    body: `Subject: File archived – [Property Address]\n\nHi [Team/Broker],\n\nThe transaction file for [Property Address] has been fully closed, funded, and archived.\n\nStored in: [Folder Path / Platform]\nRetention: [5 years or brokerage policy]\n\nAll supporting docs — contract, addenda, estoppel, CD, and deed — are uploaded and labeled per compliance standards.\n\nWe're officially done on this one.`,
    category: CONTRACT_STAGES.POST_CLOSING_COMPLETION,
  },
  {
    id: "pcf_client_appreciation",
    title: "Client Appreciation Note (Optional)",
    body: `Subject: Thank you again — and congrats on your closing 🎉\n\nHi [Client First Name],\n\nNow that the dust has settled, I just wanted to take a moment to say thank you again for trusting us with your transaction.\n\nBehind every closing is a lot of coordination, communication, and teamwork — and it's always rewarding to see it all come together for great clients like you.\n\nWishing you the very best in this next chapter, and remember — we're always here if you need anything down the road.\n\nWarm regards,`,
    category: CONTRACT_STAGES.POST_CLOSING_COMPLETION,
  },
  // Compliance & Document Requests Templates
  {
    id: "cdr_missing_document_request",
    title: "Missing Document Request (General)",
    body: `Subject: Missing document request – [Property Address]\n\nHi [Agent/Contact Name],\n\nWhile reviewing the file for [Property Address], I noticed we're still missing the following item(s):\n[List missing documents, e.g., HOA addendum, escrow receipt, or insurance binder]\n\nPlease send a copy at your earliest convenience so we can keep the file in compliance.\n\nIf you've already sent it, kindly re-forward so I can confirm it's logged correctly.\n\nThank you for your help keeping this file up to date.\n\nBest,`,
    category: CONTRACT_STAGES.COMPLIANCE_DOCUMENTS,
  },
  {
    id: "cdr_missing_signature_request",
    title: "Missing Signature Request",
    body: `Subject: Signature needed – [Document Name] for [Property Address]\n\nHi [Client/Agent Name],\n\nThe [Document Name] for [Property Address] is missing one signature on page [#].\n\nPlease review and complete the signature section when you have a moment.\n\nI've reattached the document here for convenience. Once signed, please reply with the executed version so we can finalize the file.\n\nThank you!`,
    category: CONTRACT_STAGES.COMPLIANCE_DOCUMENTS,
  },
  {
    id: "cdr_lender_insurance_binder",
    title: "Lender Insurance Binder Request",
    body: `Subject: Homeowner's insurance binder needed – [Property Address]\n\nHi [Buyer First Name],\n\nThe lender will need a copy of your homeowner's insurance binder before issuing final loan approval.\n\nPlease contact your insurance agent and have them send it directly to:\n📩 [Lender Email]\nCC: [Title Company] and me for recordkeeping.\n\nOnce sent, reply to confirm so we can check it off your list.\n\nWe're almost there!`,
    category: CONTRACT_STAGES.COMPLIANCE_DOCUMENTS,
  },
  {
    id: "cdr_title_missing_cd",
    title: "Title Company – Missing CD or Final Docs",
    body: `Subject: Request for final CD and closing package – [Property Address]\n\nHi [Title Rep Name],\n\nI'm finalizing the compliance file for [Property Address] and wanted to check if the final Closing Disclosure and fully executed closing package are available.\n\nPlease send the following when ready:\nFinal CD (buyer/seller copy)\nSigned deed and affidavit\nCommission disbursement confirmation\n\nOnce received, I'll archive the file for compliance.\n\nThank you so much for your help!`,
    category: CONTRACT_STAGES.COMPLIANCE_DOCUMENTS,
  },
  {
    id: "cdr_escrow_deposit_verification",
    title: "Escrow Deposit Verification Request",
    body: `Subject: Escrow deposit confirmation – [Property Address]\n\nHi [Title Rep Name],\n\nCould you please confirm receipt of the buyer's escrow deposit for [Property Address]?\n\nWe'd like to document the file and provide confirmation to the listing side.\n\nIf available, please forward the escrow letter or acknowledgment showing the date and amount received.\n\nThank you!`,
    category: CONTRACT_STAGES.COMPLIANCE_DOCUMENTS,
  },
  {
    id: "cdr_loan_commitment_followup",
    title: "Loan Commitment Follow-Up",
    body: `Subject: Loan commitment update – [Property Address]\n\nHi [Lender Name],\n\nChecking in on the loan commitment status for [Property Address] — the contract deadline is [Date].\n\nPlease advise if the file is on track to meet that date, or if you anticipate any delays so we can request an extension in advance.\n\nAppreciate your update,`,
    category: CONTRACT_STAGES.COMPLIANCE_DOCUMENTS,
  },
  {
    id: "cdr_hoa_approval_status",
    title: "HOA Approval Status Request",
    body: `Subject: HOA/Condo approval status – [Property Address]\n\nHi [Association Manager Name],\n\nFollowing up on the buyer's application for [Property Address] — has the board issued approval yet?\n\nWe're approaching the closing date of [Date], and confirmation is required for title clearance.\n\nPlease advise on the current status or expected turnaround time.\n\nThank you for your assistance,`,
    category: CONTRACT_STAGES.COMPLIANCE_DOCUMENTS,
  },
  {
    id: "cdr_seller_payoff_statement",
    title: "Seller Payoff Statement Request",
    body: `Subject: Payoff statement needed – [Property Address]\n\nHi [Seller Name],\n\nThe title company will need an official mortgage payoff statement to prepare for closing.\n\nPlease contact your lender and request:\nFull payoff letter (valid through [Date])\nInclude loan number and property address\nSend directly to [Title Company Email]\nCC me on the email for tracking.\n\nOnce it's received, we'll confirm clearance before closing.\n\nBest,`,
    category: CONTRACT_STAGES.COMPLIANCE_DOCUMENTS,
  },
  {
    id: "cdr_agent_compliance_upload",
    title: "Agent Compliance Upload Reminder",
    body: `Subject: Reminder – upload documents for [Property Address]\n\nHi [Agent Name],\n\nJust a quick reminder to upload the following documents to the brokerage platform for [Property Address]:\nExecuted Contract\nAddenda / Amendments\nClosing Disclosure\nSettlement Statement\nRecorded Deed\n\nOnce uploaded, please reply so I can confirm the compliance checklist is complete.\n\nAppreciate your help closing this one out!`,
    category: CONTRACT_STAGES.COMPLIANCE_DOCUMENTS,
  },
  {
    id: "cdr_missing_association_docs",
    title: "Missing Association Documents",
    body: `Subject: Missing HOA/Condo documents – [Property Address]\n\nHi [Listing Agent Name],\n\nWe're still missing the following association documents for [Property Address] required under the contract:\nLatest Financials\nBudget\nFAQ & Rules\nMaster Insurance Certificate\nApplication Package (if applicable)\n\nPlease forward as soon as possible to keep us within contract timelines.`,
    category: CONTRACT_STAGES.COMPLIANCE_DOCUMENTS,
  },
  {
    id: "cdr_tax_certificate_confirmation",
    title: "Tax Certificate / Utility Confirmation",
    body: `Subject: Municipal/tax search confirmation – [Property Address]\n\nHi [Title Rep Name],\n\nCan you please confirm if the tax certificate and utility lien search have been received for [Property Address]?\n\nI want to ensure there are no pending municipal balances that could delay title clearance.\n\nThank you for confirming,`,
    category: CONTRACT_STAGES.COMPLIANCE_DOCUMENTS,
  },
  {
    id: "cdr_missing_w9_cda",
    title: "Missing W-9 or Commission Authorization",
    body: `Subject: W-9 or CDA needed – [Property Address]\n\nHi [Agent Name],\n\nWe're missing either the W-9 or Commission Disbursement Authorization for [Property Address].\n\nPlease send at your earliest convenience so title can finalize the commission release.\n\nThank you!`,
    category: CONTRACT_STAGES.COMPLIANCE_DOCUMENTS,
  },
  {
    id: "cdr_compliance_review_audit",
    title: "Compliance Review – File Audit Reminder",
    body: `Subject: Compliance audit – document verification for [Property Address]\n\nHi [Agent Name],\n\nI'm conducting a compliance review for [Property Address] and need to confirm we have complete documentation for the transaction.\n\nPlease verify that the following are in your records:\nFully executed contract and addenda\nEscrow confirmation\nClosing statement and deed\nSigned CD and disclosures\n\nIf anything is missing, please forward or upload it by [Deadline Date] so we can mark the file "audit-ready."\n\nThanks for keeping everything clean and organized,`,
    category: CONTRACT_STAGES.COMPLIANCE_DOCUMENTS,
  },
  {
    id: "cdr_final_compliance_confirmation",
    title: "Final Compliance Confirmation",
    body: `Subject: File in full compliance – [Property Address]\n\nHi [Broker/Compliance Officer Name],\n\nThe transaction file for [Property Address] has been fully reviewed and is in compliance.\n\nAll required documents have been uploaded, including contract, addenda, title docs, estoppel, CD, and deed.\n\nPlease confirm if anything further is needed before we archive.\n\nThank you for your support — another smooth closing complete!`,
    category: CONTRACT_STAGES.COMPLIANCE_DOCUMENTS,
  },
  // Reactivation & Past Client Nurture Templates
  {
    id: "rcn_30_day_post_closing",
    title: "30-Day Post-Closing Check-In",
    body: `Subject: How's everything going at [Property Address]?\n\nHi [First Name],\n\nIt's been about a month since your closing — I hope you've settled in and are enjoying the new space!\n\nI just wanted to check in and see how everything's going. If you need any recommendations for local vendors (painters, cleaners, landscapers, or contractors), just let me know — I have a great list of trusted pros.\n\nWishing you continued happiness in your new home,`,
    category: CONTRACT_STAGES.REACTIVATION_NURTURE,
  },
  {
    id: "rcn_60_day_settling_in",
    title: "60-Day Settling In Email",
    body: `Subject: Settling in checklist & quick homeowner reminders 🏡\n\nHi [First Name],\n\nCan you believe it's already been two months since closing?\n\nHere are a few quick reminders that might be helpful around this time:\nDouble-check your homestead exemption is filed.\nSet up auto-pay for property taxes and insurance if available.\nSchedule routine maintenance (A/C filter, pest control, gutters, etc.)\n\nIf you'd like, I can also send you a quick home value snapshot — it's always interesting to see how the market is moving.\n\nHope all is well!`,
    category: CONTRACT_STAGES.REACTIVATION_NURTURE,
  },
  {
    id: "rcn_90_day_stay_connected",
    title: "90-Day Stay Connected Email",
    body: `Subject: Just checking in – how's the home treating you?\n\nHi [First Name],\n\nIt's been about three months since closing — how's everything going so far?\n\nI always love hearing updates (especially before/after photos or projects you've tackled). And of course, if you ever need to discuss market changes, refinancing options, or your home's new value, I'm happy to help.\n\nStay in touch — I'm just an email away.`,
    category: CONTRACT_STAGES.REACTIVATION_NURTURE,
  },
  {
    id: "rcn_anniversary_email",
    title: "Anniversary Email (1-Year Check-In)",
    body: `Subject: Happy Home-iversary! 🎉\n\nHi [First Name],\n\nHappy 1-year home-iversary! 🏡\n\nTime flies — I hope this past year has been full of great memories in your home.\n\nIf you'd like, I can send over a quick update on what similar homes in your area are selling for — it's always good to know where your investment stands.\n\nAnd of course, if friends or family are thinking about buying or selling, I'd love to take great care of them too.\n\nWishing you continued happiness and success,`,
    category: CONTRACT_STAGES.REACTIVATION_NURTURE,
  },
  {
    id: "rcn_feedback_review_request",
    title: "We'd Love Your Feedback (Review Request)",
    body: `Subject: Quick favor? Your feedback means a lot!\n\nHi [First Name],\n\nIt was such a pleasure working with you on your recent closing at [Property Address].\n\nIf you wouldn't mind taking a minute to leave a quick review, it really helps others find me and know what to expect.\n\nHere's the link: [Insert Link]\n\nThank you again for trusting me — I truly appreciate it.`,
    category: CONTRACT_STAGES.REACTIVATION_NURTURE,
  },
  {
    id: "rcn_referral_touchpoint",
    title: "Referral Touchpoint",
    body: `Subject: Know someone thinking of buying or selling?\n\nHi [First Name],\n\nI wanted to take a quick moment to thank you again for letting me be part of your journey at [Property Address].\n\nIf you have any friends, family, or coworkers thinking about buying, selling, or even just exploring their options — I'd love an introduction. Referrals are the highest compliment I can receive.\n\nAs always, if you ever need anything real estate–related, I'm here.\n\nWarm regards,`,
    category: CONTRACT_STAGES.REACTIVATION_NURTURE,
  },
  {
    id: "rcn_market_update_checkin",
    title: "Market Update or Check-In Email",
    body: `Subject: Quick update on your area's market trends 📈\n\nHi [First Name],\n\nThe market has shifted a bit recently, and I thought you might find this interesting:\n[City/Neighborhood] average home price: $[Value]\nDays on market: [#]\nAppreciation since you closed: [#]%\n\nIf you'd like a quick property-specific update, I can send over a snapshot showing how your home's value has performed — no strings attached.\n\nHope all is well!`,
    category: CONTRACT_STAGES.REACTIVATION_NURTURE,
  },
  {
    id: "rcn_holiday_seasonal_checkin",
    title: "Holiday or Seasonal Check-In",
    body: `Subject: Happy Holidays from our team 🎄\n\nHi [First Name],\n\nAs the year winds down, I just wanted to thank you again for trusting me with your home journey.\n\nI hope this season brings you rest, laughter, and time with the people who matter most.\n\nWishing you a wonderful holiday and an even better year ahead.\n\nWarm regards,`,
    category: CONTRACT_STAGES.REACTIVATION_NURTURE,
  },
  {
    id: "rcn_client_reactivation",
    title: "Client Reactivation (Old Leads or Past Clients)",
    body: `Subject: Still thinking about real estate this year?\n\nHi [First Name],\n\nIt's been a while since we last connected, and I wanted to check in to see how things have been going.\n\nIf you've thought about buying, selling, or investing again, I'd love to help you plan the next move — even if it's just to discuss timing or strategy.\n\nIf not, no worries at all — I'm always here when the timing feels right.\n\nTalk soon,`,
    category: CONTRACT_STAGES.REACTIVATION_NURTURE,
  },
  {
    id: "rcn_reengagement_resource",
    title: "Re-Engagement with a Resource or Gift",
    body: `Subject: Thought this might help you this season 🌟\n\nHi [First Name],\n\nI was updating some resources for my clients and thought of you — here's a quick [guide / checklist / tool] that's been super helpful lately:\n👉 [Link or Attachment]\n\nWhether you're considering another move or just keeping tabs on the market, I hope it adds value.\n\nAlways happy to help — anytime, any question.`,
    category: CONTRACT_STAGES.REACTIVATION_NURTURE,
  }
];
...
export function Templates() {
  ...
  function handleRemoveFromFavorites(templateId: string) {
    if (!hasFullAccess) {
      alert("This action is only available for Inbox Royalty subscribers.");
      return;
    }
    setFavorites(favs => favs.filter(id => id !== templateId));
  }
  ...
  function handleToggleCategory(category: string | null) {
    if (category === null) {
    ...
    <div className="w-full pl-8 pr-8 sm:pl-4 sm:pr-4" style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}>
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div className="relative flex items-center flex-1 max-w-2xl bg-white border border-[#E3E3E3] rounded-lg shadow-sm hover:shadow-md transition-shadow focus-within:border-[#161616] focus-within:shadow-md h-12">
          ...
          {searchInput && (
            <button
              ...
              className="text-[#ABABAB] hover:text-[#505050] text-lg focus:outline-none px-2"
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`w-9 h-9 flex items-center justify-center rounded-none border transition-colors
                ${view === 'favorites' ? 'bg-[#FBFBFB] border-[#161616] text-[#161616]' : 'bg-white border-[#E3E3E3] text-[#505050] hover:bg-[#FBFBFB] hover:text-[#161616] hover:border-[#ABABAB]'}`}
            aria-label="Favorites"
            title="Favorites"
          >
            <Star className="w-4 h-4" fill={view === 'favorites' ? 'currentColor' : 'none'} />
          </button>
          <button
            onClick={() => setView('recent')}
            className={`w-9 h-9 flex items-center justify-center rounded-none border transition-colors
                ${view === 'recent' ? 'bg-[#FBFBFB] border-[#161616] text-[#161616]' : 'bg-white border-[#E3E3E3] text-[#505050] hover:bg-[#FBFBFB] hover:text-[#161616] hover:border-[#ABABAB]'}`}
            aria-label="Recents"
            title="Recents"
          >
      ...
      {filteredTemplates.length === 0 ? (
          ...
          {(searchInput || selectedCategories.size > 0) && (
            <button
              onClick={() => { setSearchInput(""); setSelectedCategories(new Set()); }}
              className="mt-3 text-sm text-[#161616] hover:text-[#505050] underline"
              style={{ fontFamily: 'var(--font-inter-tight), sans-serif' }}
            >
              Clear filters
            </button>
            ...
            >
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  {hasFullAccess && (
                  <button
                      className={`ml-2 w-5 h-5 flex items-center justify-center transition ${favorites.includes(t.id) ? 'text-[#161616]' : 'text-[#ABABAB] hover:text-[#505050]'}`}
                    onClick={e => { e.stopPropagation(); handleFavorite(t.id); }}
                    aria-label={favorites.includes(t.id) ? 'Unfavorite' : 'Favorite'}
                  >
                    <Star fill={favorites.includes(t.id) ? 'currentColor' : 'none'} className="w-4 h-4" />
                  </button>
                  )}
                </div>
                  <div className="text-sm text-[#505050] truncate" style={{ fontFamily: 'var(--font-inter-tight), sans-serif', ...(!hasFullAccess ? { userSelect: 'none' } : {}) }}>
                ...
                <div className="flex items-center gap-1 action-button">
                  ...
                  <button
                    onClick={e => { e.stopPropagation(); handleCopy(t); }}
                      className="copy-btn w-9 h-9 flex items-center justify-center rounded-none border border-[#E3E3E3] hover:bg-[#FBFBFB] hover:border-[#ABABAB] transition relative group/copy"
                    aria-label="Copy Template"
                  >
                      <Clipboard className="w-4 h-4 text-[#505050]" />
                  ...
                  <a
                    href={`mailto:?subject=${encodeURIComponent(t.title)}&body=${encodeURIComponent(t.body)}`}
                      className="send-btn w-9 h-9 flex items-center justify-center rounded-none border border-[#E3E3E3] hover:bg-[#FBFBFB] hover:border-[#ABABAB] transition relative group/send"
                    aria-label="Send Template"
                    target="_blank"
                    rel="noopener noreferrer"
                    onClick={e => e.stopPropagation()}
                  >
                      <Mail className="w-4 h-4 text-[#505050]" />
                      <span className="absolute left-1/2 -translate-x-1/2 top-10 z-30 whitespace-nowrap rounded bg-[#161616] px-2 py-1 text-xs text-white opacity-0 group-hover/send:opacity-100 pointer-events-none transition-opacity">
                      Send
                    </span>
                  </a>
                  )}
                  {hasFullAccess && view === 'favorites' && (
                  <button
                    onClick={e => { e.stopPropagation(); handleRemoveFromFavorites(t.id); }}
                      className="delete-btn w-9 h-9 flex items-center justify-center rounded-none border border-[#E3E3E3] hover:bg-[#FBFBFB] hover:border-[#ABABAB] transition relative group/delete"
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              >
                <Star 
                  fill={favorites.includes(selectedTemplate.id) ? 'currentColor' : 'none'} 
                  className="w-4 h-4" 
                />
              </button>
              )}
